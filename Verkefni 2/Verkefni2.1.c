...
task main()
{
	...
	wait1Msec(1000);							// Robot runs previous code for 1000 milliseconds before moving
	motor[leftMotor]  = 0;		  // wait
	wait1Msec(500);							// Robot waits for 100 milliseconds

	motor[rightMotor] = -127;		  // Motor on port2 is run at full (127) power forward
	motor[leftMotor]  = -127;		  // Motor on port3 is run at full (127) power forward
	wait1Msec(1000);							// Robot runs previous code for 2000 milliseconds before moving on
	motor[rightMotor] = 0;		  // wait
	motor[leftMotor]  = 0;		  // wait
	wait1Msec(500);							// Robot waits for 100 milliseconds
